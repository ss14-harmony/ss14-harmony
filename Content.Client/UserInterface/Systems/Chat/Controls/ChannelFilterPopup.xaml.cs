...
using static Robust.Client.UserInterface.Controls.TextEdit; // Harmony - chat highlighting
...
public sealed partial class ChannelFilterPopup : Popup
{
    ...
    public event Action<string>? OnNewHighlights; // Harmony - chat highlighting
