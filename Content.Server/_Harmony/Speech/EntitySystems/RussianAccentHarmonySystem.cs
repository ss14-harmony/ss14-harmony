...
public sealed class RussianAccentHarmonySystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<RussianAccentHarmonyComponent, AccentGetEvent>(OnAccent);
    }

    // Applies Russian accent to a message
    public string Accentuate(string message, RussianAccentHarmonyComponent component)
    {
    ...
    private string ApplyKomradeReplacement(string message, RussianAccentHarmonyComponent component)
    {
    ...
    private string ApplyGrammarRules(string message, RussianAccentHarmonyComponent component)
    {
        if (string.IsNullOrEmpty(message))
            return message;
    ...
    private void OnAccent(EntityUid uid, RussianAccentHarmonyComponent component, AccentGetEvent args)
    {
