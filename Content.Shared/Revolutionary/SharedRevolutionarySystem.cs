using Content.Shared._Harmony.BloodOath.EntitySystems; // Harmony
...
{
    [Dependency] private readonly SharedBloodBoundSystem _bloodBrotherSystem = default!; // Harmony
    ...
    private void MindShieldImplanted(EntityUid uid, MindShieldComponent comp, MapInitEvent init)
    {
        ...
        _bloodBrotherSystem.OnBloodBoundMindshielded((uid, comp), ref init); // Harmony (who doesn't love some good old hardcoding)
    }
