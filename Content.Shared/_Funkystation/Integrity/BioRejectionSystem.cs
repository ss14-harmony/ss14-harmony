...
public sealed class BioRejectionSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out _, out var damageable, out _))
        {
            ...
            var current = _damageable.GetDamageOfType(damageableEnt, BioRejectionDamageType).Float();
            ...
            _damageable.TryChangeDamage(damageableEnt, damage, ignoreResistances: false, interruptsDoAfters: false, origin: null);
        }
    }
}
